...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void loafData(String title){
        ...
        Toast.makeText(this, "Loading "+
                fileModel.getFilename()+" data", Toast.LENGTH_SHORT).show();
    }
    ...
    public void saveFile(){
        if (editTitle.getText().toString().isEmpty()){
            Toast.makeText(this,
                    "Tittle harus diisi terlebih dahulu", Toast.LENGTH_SHORT).show();
        }else if (editContent.getText().toString().isEmpty()){
            Toast.makeText(this,
                    "Kontent harus diisi terlebih dahulu", Toast.LENGTH_SHORT).show();
        }else {
            ...
            Toast.makeText(this,
                    "Saving "+fileModel.getFilename()+" file", Toast.LENGTH_SHORT).show();
        }
    }
